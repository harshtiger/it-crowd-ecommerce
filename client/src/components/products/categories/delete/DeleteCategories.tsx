...
export default function DeleteCateogires(): JSX.Element {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>): void => {
        ...
        if (categories.subcategory !== 0) {
            ...
            swal({
                title: 'category or subcategory are not selected',
                icon: 'error'
            })
        }
                    ...
                    >
                        <option hidden>Select category</option>
                        {
                            allCategories.length > 0
                                ...
                                : <option>There are no categories with no subcategory connected</option>
                        }
                    </select>
                    ...
                    >
                        <option hidden>Select subcategory</option>
                        {
                            allSubcategories.length > 0
                                ...
                                : <option>No subcategories aviable</option>
                        }
                    </select>
                </div>
